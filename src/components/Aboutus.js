...
const Aboutus = () => {
    return (
      <>
        <div>
          <div class="page-banner overlay-dark bg-image"style={{ backgroundImage:`url(${one})` }}  >
            ...
            <div class="col-md-6 col-lg-4 wow zoomIn">
              <div class="card-doctor">
                <div class="header">
                  ...
                  <div class="meta">
                    <NavLink to="#"><span class="mai-call"></span></NavLink>
                    <NavLink to="#"><span class="mai-logo-whatsapp"></span></NavLink>
                  </div>
                </div>
                <div class="body">
    ...
    <div class="container py-5 py-lg-0">
      <div class="row align-items-center">
        ...
        <div class="col-lg-8 wow fadeInRight">
          ...
          <NavLink to="#" class="ml-2"><img src="../assets/img/app_store.svg" alt=""/></NavLink>
        </div>
      </div>
    </div>
  </div> </div>
